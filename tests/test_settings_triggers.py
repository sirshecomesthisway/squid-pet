...
def test_empty_settings_yields_five_enabled_one_off():
    """Default config: code_puppy + claude_code + codex + git + ide are
...
def test_all_off_yields_all_disabled():
    s = {"triggers": {
        "code_puppy": False, "claude_code": False, "codex": False,
...
def test_default_triggers_contains_expected_keys():
    for k in ("code_puppy", "claude_code", "codex", "git", "terminal", "ide",
